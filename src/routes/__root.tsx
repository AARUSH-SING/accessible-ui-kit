  ...
  head: () => ({
    meta: [
      ...
      { title: "Accessible React Component Library" },
      {
        name: "description",
        content:
          "WCAG-aligned React and TypeScript components with keyboard navigation, focus management and screen reader support.",
      },
      { property: "og:title", content: "Accessible React Component Library" },
      {
